...
summary: "During my holiday and spare time I went through a book I saw referenced on the internet, from the O'reilly series on software Architecture. I appreciated so much what I learned from it that I decided to write a summary of it (with some help of chat GPT to get some wording inspirations). I hope you will enjoy it as much as I did."
tags: ['software architecture', 'book', 'architecture', 'software', 'engineering', 'programming', 'design', 'patterns', 'principles', 'quality attributes', 'communication', 'collaboration', 'decision making', 'evolution', 'technical debt', 'case studies']
date: '2024-01-08'
draft: false
---
